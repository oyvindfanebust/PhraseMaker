...
namespace PhraseMaker.Tests
{
    ...
    public class EmbeddedResourceWordStoreTests
    {
        ...
        {
            var wordStore = new EmbeddedResourceWordStore(Assembly.GetExecutingAssembly(), "PhraseMaker.Tests.Embedded") { Randomizer = (from, to) => 1 };
        ...
        {
            var exception = Assert.Throws<ApplicationException>(() => new EmbeddedResourceWordStore(Assembly.GetExecutingAssembly(), "PhraseMaker.Tests.Embedded.NoNoun"));
        ...
        {
            var exception = Assert.Throws<ApplicationException>(() => new EmbeddedResourceWordStore(Assembly.GetExecutingAssembly(), "PhraseMaker.Tests.Embedded.NoAdjective"));
